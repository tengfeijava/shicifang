...
public class RecruitController {
	...
	public Result stateRecimmend(){
        List<Recruit> recimmend = recruitService.recimmendPost();
        return new Result(true,StatusCode.OK,"查询成功",recimmend);
	}
	/*
	   最新职位
    ...
    public Result newestPost(){
        List<Recruit> newestPost = recruitService.newestPost();
        return new Result(true,StatusCode.OK,"查询成功",newestPost);
    }
}
